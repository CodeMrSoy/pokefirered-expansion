...
#define MOTHIM_SPECIES_INFO(rzMode)                                                \
    ...
    [SPECIES_MOTHIM_PLANT] = MOTHIM_SPECIES_INFO(MON_RANDOMIZER_INVALID),
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal, rzMode)                                \
    ...
    [SPECIES_ARCEUS_FIGHTING] = ARCEUS_SPECIES_INFO(TYPE_FIGHTING, Fighting, 1, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_FLYING]   = ARCEUS_SPECIES_INFO(TYPE_FLYING,   Flying,   2, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_POISON]   = ARCEUS_SPECIES_INFO(TYPE_POISON,   Poison,   2, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_GROUND]   = ARCEUS_SPECIES_INFO(TYPE_GROUND,   Ground,   1, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_ROCK]     = ARCEUS_SPECIES_INFO(TYPE_ROCK,     Rock,     2, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_BUG]      = ARCEUS_SPECIES_INFO(TYPE_BUG,      Bug,      1, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_GHOST]    = ARCEUS_SPECIES_INFO(TYPE_GHOST,    Ghost,    2, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_STEEL]    = ARCEUS_SPECIES_INFO(TYPE_STEEL,    Steel,    0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_FIRE]     = ARCEUS_SPECIES_INFO(TYPE_FIRE,     Fire,     0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_WATER]    = ARCEUS_SPECIES_INFO(TYPE_WATER,    Water,    0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_GRASS]    = ARCEUS_SPECIES_INFO(TYPE_GRASS,    Grass,    1, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_ELECTRIC] = ARCEUS_SPECIES_INFO(TYPE_ELECTRIC, Electric, 3, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_PSYCHIC]  = ARCEUS_SPECIES_INFO(TYPE_PSYCHIC,  Psychic,  1, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_ICE]      = ARCEUS_SPECIES_INFO(TYPE_ICE,      Ice,      0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_DRAGON]   = ARCEUS_SPECIES_INFO(TYPE_DRAGON,   Dragon,   0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_DARK]     = ARCEUS_SPECIES_INFO(TYPE_DARK,     Dark,     0, MON_RANDOMIZER_NORMAL),
    [SPECIES_ARCEUS_FAIRY]    = ARCEUS_SPECIES_INFO(TYPE_FAIRY,    Fairy,    0, MON_RANDOMIZER_NORMAL),
