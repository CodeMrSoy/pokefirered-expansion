...
const u32 gItemIcon_PokeCocaine[] = INCBIN_U32("graphics/items/icons/powder_jar.4bpp.lz");
const u16 gItemIconPalette_PokeCocaine[] = INCBIN_U16("graphics/items/icon_palettes/powder_jar.gbapal");
