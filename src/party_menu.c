...
void ItemUseCB_LevelCapCandy(u8 taskId, TaskFunc func);
static void ItemUseCB_LevelCapCandyStep(u8 taskId, TaskFunc func);
...
void ItemUseCB_LevelCapCandy(u8 taskId, TaskFunc func)
{
    ...
    Task_DoUseItemAnim(taskId);
    gItemUseCB = ItemUseCB_LevelCapCandyStep;
}
